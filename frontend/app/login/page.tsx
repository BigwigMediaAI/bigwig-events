...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[var(--bg)] text-[var(--text)]">
      ...
      rounded-full bg-[var(--secondary)]/20 blur-[220px]"
        />
      </section>
      ...
      <section className="relative bg-[var(--bg)]">
        {/* Decorative glow */}
        <div className="absolute -top-40 -left-40 w-[420px] h-[420px] bg-[var(--secondary)]/10 rounded-full blur-3xl" />
        <div className="absolute bottom-0 right-0 w-[360px] h-[360px] bg-[var(--secondary)]/10 rounded-full blur-3xl" />
      ...
      "
          >
            ...
            <div className="hidden md:flex flex-col justify-center p-12">
              <h2 className="text-3xl font-bold text-[var(--secondary)] mb-4">
                Admin Control Panel
              </h2>
